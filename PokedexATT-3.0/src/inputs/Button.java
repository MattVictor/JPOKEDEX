...
public class Button {
	...
	// altera a variavel que diz se o mouse esta sobre o botao
	...
	// retorna se o ponto atual dado esta sobre o botao quando o mouse clicar
